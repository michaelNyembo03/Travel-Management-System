    ...
    <body>
        ...
        <div class="bookingWrapper">
            ...
            <?php
                ...
                $_SESSION["distanceCabs"] = $distance;
            ...
            ?>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="boxLeftCabs">
                        ...
                        <div class="col-sm-3 borderRight">
                            <div class="noOfRooms">
                                <?php echo $_SESSION["carTypeCabs"]; ?>
                            </div>
                            <div class="noOfRoomsSubscript">Type of Car</div>
                        </div>
                        
                        <div class="col-sm-3">
                            <div class="noOfGuests"><?php echo $_SESSION["distanceCabs"]." km"; ?></div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-8">
                        <div class="heading">Distance (<?php echo $_SESSION["distanceCabs"]; ?>km @ <span class="sansSerif">₹</span> 5.5/km) </div>
                        <div class="heading">Time (<?php echo $_SESSION["timeCabs"]; ?> min @ <span class="sansSerif">₹</span> 1.25/min) </div>
                        <div class="heading">Convenience Fee</div>  
                    </div>
                    
                    <div class="col-sm-4">
                        <div class="price"><span class="sansSerif">₹</span><?php echo $_SESSION["distanceCabs"]*5.5; ?></div>
                        <div class="price"><span class="sansSerif">₹</span><?php echo $rowCab["time"]*1.25; ?></div>
                        <div class="price"><span class="sansSerif">₹</span>250</div>
                    </div>
                    
                    <?php $totalFare=($_SESSION["distanceCabs"]*5.5)+($rowCab["time"]*1.25+250); ?>
                    
                    <?php elseif($carType=="Sedan"): ?>
                    
                    <div class="col-sm-8">
                        <div class="heading">Distance (<?php echo $_SESSION["distanceCabs"]; ?>km @ <span class="sansSerif">₹</span> 8.75/km) </div>
                        <div class="heading">Time (<?php echo $_SESSION["timeCabs"]; ?> min @ <span class="sansSerif">₹</span> 2/min) </div>
                        <div class="heading">Convenience Fee</div>  
                    </div>
                    
                    <div class="col-sm-4">
                        <div class="price"><span class="sansSerif">₹</span><?php echo $_SESSION["distanceCabs"]*8.75; ?></div>
                        <div class="price"><span class="sansSerif">₹</span><?php echo (int)$_SESSION["timeCabs"]*2; ?></div>
                        <div class="price"><span class="sansSerif">₹</span>250</div>
                    </div>
                    
                    <?php $totalFare=((double)$_SESSION["distanceCabs"]*8.75)+((double)$_SESSION["timeCabs"]*2+250); ?>
                    
                    <?php elseif($carType=="SUV"): ?>
                    
                    <div class="col-sm-8">
                        <div class="heading">Distance (<?php echo $_SESSION["distanceCabs"]; ?>km @ <span class="sansSerif">₹</span> 13.25/km) </div>
                        <div class="heading">Time (<?php echo $_SESSION["timeCabs"]; ?> min @ <span class="sansSerif">₹</span> 3.75/min) </div>
                        <div class="heading">Convenience Fee</div>  
                    </div>
