   							...
   							<div class="form-group">
   								 <label for="city">City:<p> </p></label>
      								...
      								<select id= "city"  data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" required>
        								...
        								<option value="Likasi" data-tokens="LKS Likasi">Likasi</option>
        								<option value="Matadi" data-tokens="MTD Matadi">Matadi</option>
        								<option value="Kalemi" data-tokens="MAN Kalemi">Kalemi</option>
        								<option value="Kananga" data-tokens="SHL Kananga">Kananga</option>
      								</select>
							</div>
            			</div>
							...
							<div  class="col-sm-4">
								...
								<div class="listItem">
									...
									<div class="imageContainer text-center">
										...
										<img src="images/hotels/cities/Matadi/radissonBlu.jpg" alt="Matadi Hotels">
									...
									<div class="info">
										...
										3-star hotels averaging Fc2000
										
									</div>
									
									<div class="info">
										
										5-star hotels averaging Fc6500
							...
							<div  class="col-sm-4">
								...
								<div class="listItem">
									...
									<div class="imageContainer text-center">
										...
										<img src="images/hotels/cities/Kolwezi/JWMarriott.jpg" alt="Kolwezi Hotels">
									...
									<div class="info">
										...
										3-star hotels averaging Fc3900
										
									</div>
									
									<div class="info">
										
										5-star hotels averaging Fc9700
							...
							<div  class="col-sm-4">
								...
								<div class="listItem">
									...
									<div class="imageContainer text-center">
										...
										<img src="images/hotels/cities/Kasai/HyattRegency.jpg" alt="kasai Hotels">
									...
									<div class="info">
										...
										3-star hotels averaging Fc3000
										
									</div>
									
									<div class="info">
										
										5-star hotels averaging Fc7750
